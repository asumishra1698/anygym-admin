          ...
          <ul className="space-y-4">
            ...
            <li>
              ...
              >
                ...
                {!initialIsCollapsed && <span className="ml-3">Gym Owner</span>}
              </Link>
            </li>
            ...
            <li>
              ...
              >
                ...
                {!initialIsCollapsed && <span className="ml-3">Products</span>}
              </Link>
            </li>
            <li>
              <Link
              ...
              >
                <AcademicCapIcon className="w-5 h-5" />
                {!initialIsCollapsed && (
                  <span className="ml-3">Products Category</span>
                )}
              </Link>
            </li>
            ...
            <li>
              ...
              >
                ...
                {!initialIsCollapsed && <span className="ml-3">Customers</span>}
              </Link>
            </li>
            ...
            <li>
              ...
              >
                <ClipboardListIcon className="w-5 h-5" />
                {!initialIsCollapsed && (
                  <span className="ml-3">Payment & Wallet</span>
                )}
              </Link>
            </li>
